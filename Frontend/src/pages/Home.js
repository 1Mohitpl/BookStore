        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {isAuthenticated ? (
              <Link
                to="/books"
                className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white px-8 py-3.5 rounded-full font-semibold shadow-md hover:-translate-y-1 hover:shadow-lg transition-all text-lg"
              >
                Browse Books
              </Link>
            ) : (
              <>
                ...
                <Link
                  to="/signup"
                  className="bg-white text-indigo-600 border border-indigo-200 px-8 py-3.5 rounded-full font-semibold shadow-sm hover:bg-slate-50 hover:-translate-y-1 transition-all text-lg"
                >
                  Sign Up
                </Link>
              </>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-slate-50 p-8 rounded-3xl text-center border border-slate-200/60 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-slate-500 leading-relaxed">
                Millions of titles across all genres to fuel your imagination.
              </p>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl text-center border border-slate-200/60 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              <span className="text-5xl mb-6 block drop-shadow-sm">💰</span>
              ...
              <p className="text-slate-500 leading-relaxed">
                Competitive pricing and frequent discounts you'll love.
              </p>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl text-center border border-slate-200/60 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              <span className="text-5xl mb-6 block drop-shadow-sm">🚚</span>
        ...
        <section className="py-20 bg-gradient-to-r from-indigo-50 to-pink-50 text-center border-y border-indigo-100">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <p className="text-slate-600 mb-8 text-lg">
              Manage inventory, handle orders, and view analytics from the admin dashboard.
            </p>
            <Link
              to="/admin"
              className="inline-block bg-slate-900 text-white px-8 py-3.5 rounded-full font-semibold shadow-md hover:bg-slate-800 hover:-translate-y-1 transition-all"
            >
              Go to Admin Panel
            </Link>
          </div>
      ...
      <section className="py-24 text-center bg-slate-50 relative overflow-hidden">
        <div className="max-w-3xl mx-auto px-6 relative z-10">
          ...
          <p className="text-slate-500 text-lg mb-10">
            Browse our extensive collection and find your next favorite book.
          </p>
          {isAuthenticated ? (
            <Link
              to="/books"
              className="inline-block bg-gradient-to-r from-indigo-600 to-violet-600 text-white px-10 py-4 rounded-full font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all text-lg"
            >
              Browse All Books
            </Link>
          ) : (
