...
const Books = () => {
    ...
    if (loading) {
        return <div className="text-center py-20 text-slate-500 text-xl font-medium animate-pulse">Loading books...</div>;
    }
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
            ...
            {filteredBooks.length === 0 ? (
                <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-slate-200">
                    <p className="text-xl text-slate-500 font-medium">No books found matching your criteria.</p>
                </div>
            ) : (
