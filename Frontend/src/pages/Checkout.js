      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-slate-200">
          ...
          <button
            ...
            className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white px-8 py-3 rounded-full font-semibold shadow-md hover:-translate-y-1 transition-all"
          >
            Continue Shopping
          </button>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 h-max">
          ...
          <div className="mb-6">
            ...
            {cartItems.map(item => (
              <div
                key={item._id}
                className="flex justify-between py-3 border-b border-dashed border-slate-200 text-slate-600"
              >
                <span>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
          ...
          <form onSubmit={handlePlaceOrder}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-bold py-4 rounded-xl shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all mb-4 disabled:opacity-50 disabled:cursor-not-allowed disabled:-translate-y-0"
            >
