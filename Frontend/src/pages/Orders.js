  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto px-6 py-20 text-center">
        <p className="text-xl text-slate-500 font-medium animate-pulse">Loading your orders...</p>
      </div>
    );
  }
          ...
          {orders.map(order => (
            ...
            >
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-slate-200 pb-4 mb-4 gap-4">
                ...
                <div>
                  <span
                    className={`px-4 py-1.5 rounded-full text-sm font-bold tracking-wider inline-block ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-slate-900 mb-3 border-b border-slate-100 pb-2">
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                  <h4 className="font-semibold text-slate-900 mb-3 border-b border-slate-200 pb-2">
                    Billing Details
                  </h4>
                  ...
                  <p className="text-slate-600 text-lg mt-4 border-t border-slate-200 pt-3">
                    <strong className="text-slate-800">Total Amount:</strong>{' '}
